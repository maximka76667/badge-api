...
app.get('/:text1-:text2-:color1-:color2-:bgColor1-:bgColor2', (req, res) => {
    ...
    const [textColor1, textColor2, boxColor1, boxColor2, textSize1, textSize2] =
        [
            convertColor(color1),
            convertColor(color2),
            convertColor(bgColor1),
            convertColor(bgColor2),
            getPixelWidth(text1, false),
            getPixelWidth(text2, true),
        ]
  ...
  <g shape-rendering="crispEdges">
    ...
    <text
      font-weight="bold"
      letter-spacing="1.5"
    fill='${textColor2}' font-family="-apple-system,BlinkMacSystemFont,Segoe UI,Helvetica,Arial,sans-serif,Apple Color Emoji,Segoe UI Emoji" x='${
            textSize1 + 10
        }' y='18'>${text2.toUpperCase()}</text>
    </g>
</svg>`)
    )
})
